...
export default function Sets() {
  const rows = [
    ...
    },
    {
      ...
      python: [
        ["my_friends.intersection(your_friends)", "my_friends & your_friends"]
      ]
    },
    {
      ...
      python: [
        ["my_friends.difference(your_friends)", "my_friends - your_friends"]
      ]
    },
    {
      description: "Union",
    ...
    },
    {
      ...
      python: [
        [
          "my_friends.symmetric_difference(your_friends)",
